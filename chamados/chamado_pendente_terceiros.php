...
<head>
    ...
    <title>Chamados pendentes de terceiros</title>
...
<body>
    ...
    <main class="container">
        ...
        <h1>Chamados pendentes de terceiros</h1>
        <a href="imprime_relatorio_pendente_terceiros.php" class="print">
