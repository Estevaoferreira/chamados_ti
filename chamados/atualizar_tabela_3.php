...
$query = "SELECT cod_chamado, data_hora_executar, setor_solicitante, nome_solicitante, status_chamado FROM chamado WHERE status_chamado = 'PENDENTE DE TERCEIROS'  ORDER BY data_hora_executar";
