...
$sql = "SELECT * FROM chamado WHERE status_chamado = 'PENDENTE DE TERCEIROS'  ORDER BY data_hora_executar";
...
echo "<br><button><a href='chamado_pendente_terceiros.php'>Voltar</a></button>";
